...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">Click on more Information to see information about OPD doctor assigned to patient.</h4>
<br />
...
<th><strong>Medical History</strong></th>
...
<?php
$count=1;
$sel_query="SELECT patient.pet_id,patient.pet_fn,patient.pet_sn,patient.Pet_opdid,patient.pet_bg,patient.pet_em,patient.pet_con,patient.med_his,staff.smfname,staff.smlname
FROM staff
RIGHT JOIN patient
...
<tr valign="middle">
    ...
    <td  align="left"><?php echo $row["pet_fn"]; ?> <?php echo $row["pet_sn"]; ?></td>
	  <td  align="left"><?php echo $row["pet_em"]; ?></td>
    <td  align="left"><?php echo $row["pet_con"]; ?></td> 
    <td  align="left"><?php echo $row["pet_bg"]; ?></td>
    <td  align="left"><?php echo $row["med_his"]; ?></td>
