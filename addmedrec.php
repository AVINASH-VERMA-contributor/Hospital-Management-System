...
<h3 style="font-family:calibri;" class="text-center">Add Medical Record</h3></div>
<br />
...
<h3 class="panel-title text-center">Patient Medical Record</h3>
</div>
<center>
...
<tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 ">Prescribed Medicine<input name="pm"  required="required"   type="text" class="form-control" placeholder="Medicine Prescribed"></div></td>
    </tr>
<tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 ">Disease<input name="dis"  required="required"   type="text" class="form-control" placeholder="Disease diagnosed"></div></td>
    </tr>
