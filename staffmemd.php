...
<div class="row">
  ...
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="staffmemd.php"><strong>Staff Members Details</strong></a></li>
...
<tr>
    ...
    <td align="center"><?php echo $row["smspec"]; ?></td>
