	 ...
	 if($sm_type == "syst" | $sm_gender == "syg" | $sm_workt == "sywt" )
	 {
		...
		if(isset($rowem['smtel'])==$sm_cont){
           $conduperr = '<br/ ><div style="font-size:12px" align="center" class="alert alert-danger">The Contact Number you                         entered is already in use!</div>';
		      ...
		      (`smfname`, `smlname`, `smtype`,`smspec`, `smbd`, `smtel`, `smemail`, `smgender`, `smwoti`, `smaddr`,`instetd_by`)
		       VALUES
		      ('$smf_name','$sms_name','$sm_type','$sm_spec','$sm_bd','$sm_cont','$sm_em','$sm_gender','$sm_workt','$sma_add','$insi')";
