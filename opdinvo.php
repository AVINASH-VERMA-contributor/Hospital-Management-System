...
<h3 style="font-family:calibri;" class="text-center">OPD Patient Invoice</h3></div>
<br />
...
<tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 ">Lab Test Charges<input name="hc"  required="required"   type="number" class="form-control" placeholder="Lab Test Charges"></div></td>
    </tr>
