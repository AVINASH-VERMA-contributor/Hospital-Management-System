...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="sestaffactmem.php"><strong>Staff Members Search</strong></a></li>
...
('<?php echo $emlduperr; ?>');</script></td>
  ...
  <tr>
    <td colspan="2" style="padding:5px;"><div class="input-group col-md-12 col-xs-12 "><select name="spec" required="required"  class="form-control" placeholder="Select the specialization">
    <option value="">Specialization</option>    
    <option value="Physician">Physician</option>
    <option value="Cardiologist">Cardiologist</option>
    <option value="Dentist">Dentist</option>
    <option value="ENT">ENT</option>
    <option value="Eye">Eyes Specialist</option>
    <option value="Surgeon">Surgeon</option>
    <option value="Ortho">Orthopaedic surgeon</option>
