...
<div class="row">
<div class="col-md-12 ">
<h4 style="font-family:calibri;" class="text-center">By clicking view can view or print patient invoice. Click on add medical record to store the patient's medical record.</h4>
<br />
...
<tr>
    ...
    <td align="center"><a target="_blank" href="addmedrec.php?id=<?php echo $row["invo_id"]; ?> & ide=<?php echo $row["invo_pet_id"]; ?>" name="mr">Add Medical Record</a></td>
