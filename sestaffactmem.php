...
if (isset($_POST['filter'])){
	...
	$self_query = "SELECT * FROM `staff` WHERE concat(`staffID`, `smtel`,`smemail`,`smfname`,`smtype`,`smwoti`,`smspec`) like '%$search%' ORDER BY `staffID` DESC";
...
Staff member Name : <?php echo $row["smfname"]; ?> <?php echo $row["smlname"]; ?><br />
</h4>
...
<dt style="font-size:12px;"><strong>Specialization: </strong></dt></dt>
<dd style="font-size:12px;"><?php echo $row["smspec"]; ?></dd>
