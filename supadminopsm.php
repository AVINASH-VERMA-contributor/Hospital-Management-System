...
<form class="" action="" method="post" id="upform">
  ...
  <dt style="font-size:12px;"><strong>Staff Reg.No :</strong> </dt>
  <dd style="font-size:12px;"><?php echo $row["staffID"]; ?></dd>
<br>
  <dt style="font-size:12px;"><strong>Staff Member First Name : </strong> </dt>
...
<br>
  ...
  <dt style="font-size:12px;"><strong>Staff Member Last Name : </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Staff Memeber Type: </strong></dt>
      ...
      <select  id="gen" disabled style="margin:5px" name="gender" required="required"  class="form-control" placeholder="Select your Gendere">
          ...
          <dt style="font-size:12px;"><strong>Specialization: </strong></dt>
          <dd style="font-size:12px;">
          <select  id="gen" disabled style="margin:5px" name="spec" required="required"  class="form-control" placeholder="Select your Gendere">
              <option  value="<?php echo $row["smspec"]; ?>"><?php echo $row["smspec"]; ?></option>
