...
<h1 class="text-center ">City Hospital<br /><small style="font-size:20px">Hospital Management System</small></h1>
</div>
</div>
</div>
<br /><br><br>
...
<img id="mimg" src="images/log/login.png" class="img-responsive" style="border:1px solid black;border-radius:100px;padding:10px" />
</div>
</div>
</div>
<br />
